...
int main()
{
	...
	unsigned int ubiLight, ubiPrimitive, ubiAlpha, ubiModel, ubiMirror, ubiRefraction, ubiCubeMap;
	...
	ubiPrimitive = glGetUniformBlockIndex(primitiveShader, "Matrices");
	ubiAlpha = glGetUniformBlockIndex(alphaShader, "Matrices");
	ubiModel = glGetUniformBlockIndex(modelShader, "Matrices");
	ubiMirror = glGetUniformBlockIndex(mirrorShader, "Matrices");
	ubiRefraction = glGetUniformBlockIndex(refractionShader, "Matrices");
	ubiCubeMap = glGetUniformBlockIndex(skyboxShader, "Matrices");
	
	glUniformBlockBinding(lightShader, ubiLight, 0);
	glUniformBlockBinding(primitiveShader, ubiPrimitive, 0);
	glUniformBlockBinding(alphaShader, ubiAlpha, 0);
	glUniformBlockBinding(modelShader, ubiModel, 0);
	glUniformBlockBinding(mirrorShader, ubiMirror, 0);
	glUniformBlockBinding(refractionShader, ubiRefraction, 0);
